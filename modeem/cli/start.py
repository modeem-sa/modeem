...
from modeem.modules.module import get_module_root, MANIFEST_NAMES
from modeem.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """Quick start the Modeem server for your project"""
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            modeem.tools.config['init']['base'] = True
