        ...
        try:
            ...
            for model in ordered_models:
                if profiling_enabled:
                    profiling_context = modeem.tools.profiler.Profiler(
                ...
                if commit:
                    ...
                    commit_context = patch('modeem.sql_db.Cursor.commit')
