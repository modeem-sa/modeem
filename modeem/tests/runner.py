...
stats_logger = logging.getLogger('modeem.tests.stats')
...
$
""", re.VERBOSE)
class ModeemTestResult(unittest.result.TestResult):
    """
    ...
    def getErrorCallerInfo(self, error, test):
        ...
        # only test case should be executed in modeem, this is only a safe guard
