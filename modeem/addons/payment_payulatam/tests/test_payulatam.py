...
from modeem.addons.payment_payulatam.controllers.main import PayuLatamController
from modeem.addons.payment_payulatam.models.payment_provider import SUPPORTED_CURRENCIES
from modeem.addons.payment_payulatam.tests.common import PayULatamCommon
...
class PayULatamTest(PayULatamCommon, PaymentHttpCommon):
    ...
    @mute_logger('modeem.addons.payment_payulatam.controllers.main')
    ...
    def test_webhook_notification_triggers_signature_check(self):
        ...
        url = self._build_url(PayuLatamController._webhook_url)
        with patch(
            'modeem.addons.payment_payulatam.controllers.main.PayuLatamController'
