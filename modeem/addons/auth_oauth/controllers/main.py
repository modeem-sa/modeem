...
from modeem import api, http, SUPERUSER_ID, _
from modeem.exceptions import AccessDenied
from modeem.http import request, Response
from modeem import registry as registry_get

from modeem.addons.auth_signup.controllers.main import AuthSignupHome as Home
from modeem.addons.web.controllers.utils import ensure_db, _get_login_redirect_url
...
class OAuthController(http.Controller):
    ...
    def oea(self, **kw):
        """login user via Modeem Account provider"""
