...
from modeem.http import root, Request, Response, SessionExpiredException
from modeem.modules.registry import Registry
from modeem.service import model as service_model
from modeem.service.server import CommonServer
from modeem.service.security import check_session
...
def acquire_cursor(db):
    ...
    for tryno in range(1, MAX_TRY_ON_POOL_ERROR + 1):
        with suppress(PoolError):
            return modeem.registry(db).cursor()
