...
class GoogleCalendarController(http.Controller):
    ...
    def sync_data(self, model, **kw):
        """ This route/function is called when we want to synchronize Modeem
            ...
            The dictionary may contains an url, to allow Modeem Client to redirect user on
        ...
        if model == 'calendar.event':
            ...
            # Checking that user have already accepted Modeem to access his calendar !
