...
from modeem.addons.account_payment.tests.common import AccountPaymentCommon
...
class TestSalePayment(AccountPaymentCommon, SaleCommon, PaymentHttpCommon):
    ...
    def test_11_so_payment_link(self):
        ...
        with patch(
            'modeem.addons.payment.controllers.portal.PaymentPortal'
    ...
    def test_12_so_partial_payment_link(self):
        ...
        tx_sudo._set_done()
        with mute_logger('modeem.addons.sale.models.payment_transaction'):
            tx_sudo._finalize_post_processing()
