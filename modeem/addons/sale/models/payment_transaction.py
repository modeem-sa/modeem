...
from modeem import _, api, Command, fields, models, SUPERUSER_ID
from modeem.tools import format_amount, str2bool
...
class PaymentTransaction(models.Model):
    ...
    def _log_message_on_linked_documents(self, message):
        ...
        self = self.with_user(SUPERUSER_ID)  # Log messages as 'ModeemBot'
