...
from modeem.addons.payment_alipay.controllers.main import AlipayController
from modeem.addons.payment_alipay.tests.common import AlipayCommon
...
class AlipayTest(AlipayCommon, PaymentHttpCommon):
    ...
    @mute_logger('modeem.addons.payment_alipay.controllers.main')
    def test_webhook_notification_confirms_transaction(self):
        ...
        with patch(
            'modeem.addons.payment_alipay.controllers.main.AlipayController'
