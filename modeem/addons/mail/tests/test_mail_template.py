...
from modeem.tests import Form, tagged, users
from modeem.tools import convert_file
...
class TestMailTemplateReset(MailCommon):
    ...
    def test_mail_template_reset(self):
        ...
        self.assertEqual(mail_template.body_html.strip(), Markup('<div>Hello Modeem</div>'))
