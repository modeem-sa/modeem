...
from modeem import Command, fields
from modeem.addons.mail.models.mail_channel import channel_avatar, group_avatar
from modeem.addons.mail.tests.common import mail_new_test_user
from modeem.addons.mail.tests.common import MailCommon
from modeem.exceptions import AccessError, UserError
from modeem.tests import tagged, Form
from modeem.tests.common import users
from modeem.tools import html_escape, mute_logger
from modeem.tools.misc import DEFAULT_SERVER_DATETIME_FORMAT
...
class TestChannelAccessRights(MailCommon):
    ...
    @mute_logger('modeem.addons.base.models.ir_rule', 'modeem.addons.base.models.ir_model', 'modeem.models')
    @users('user_public')
