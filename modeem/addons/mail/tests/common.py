...
from modeem.addons.base.models.ir_mail_server import IrMailServer
from modeem.addons.base.tests.common import MockSmtplibCase
from modeem.addons.bus.models.bus import ImBus, json_dump
from modeem.addons.mail.models.mail_mail import MailMail
from modeem.addons.mail.models.mail_message import Message
from modeem.addons.mail.models.mail_notification import MailNotification
from modeem.tests import common, new_test_user
from modeem.tools import formataddr, mute_logger, pycompat
from modeem.tools.translate import code_translations
...
class MailCommon(common.TransactionCase, MailCase):
    ...
    def _activate_multi_lang(cls, lang_code='es_ES', layout_arch_db=None, test_record=False, test_template=False):
        ...
        with mute_logger("modeem.addons.base.models.ir_module", "modeem.tools.translate"):
