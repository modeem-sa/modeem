...
from modeem import api, release, SUPERUSER_ID
from modeem.exceptions import UserError
from modeem.models import AbstractModel
from modeem.tools.translate import _
from modeem.tools import config, misc, ustr
...
class PublisherWarrantyContract(AbstractModel):
    ...
    def update_notification(self, cron_mode=True):
        """
        Send a message to Modeem's publisher warranty server to check the
