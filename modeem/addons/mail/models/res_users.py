...
from modeem import _, api, exceptions, fields, models, modules, tools
from modeem.addons.base.models.res_users import is_selection_groups
...
class Users(models.Model):
    ...
    _sql_constraints = [(
        ...
        "Only internal user can receive notifications in Modeem",
    )]

    @api.depends('share')
    def _compute_notification_type(self):
        for user in self:
            # Only the internal users can receive notifications in Modeem
