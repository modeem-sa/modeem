...
class MailMail(models.Model):
    ...
    auto_delete = fields.Boolean(
        'Auto Delete',
        help="This option permanently removes any track of email after it's been sent, including from the Technical menu in the Settings, in order to preserve storage space of your Modeem database.")
        ...
        for mail_server_id, smtp_from, batch_ids in self._split_by_mail_configuration():
            ...
            try:
                ...
                if raise_exception:
                    ...
                    # exceptions, it is encapsulated into an Modeem MailDeliveryException
