...
Communicate with your colleagues/customers/guest within Modeem.
...
from Modeem itself, and that too with great possibilities. For example,
...
these accounts will be automatically downloaded into your Modeem system. All
POP3/IMAP-compatible servers are supported, included those that require an
encrypted SSL/TLS connection.
This can be used to easily create email-based workflows for many email-enabled Modeem documents, such as:
----------------------------------------------------------------------------------------------------------
...
mailbox-to-Modeem integration. Even better: these documents directly act as mini
conversations synchronized by email. You can reply from within Modeem, and the
