...
from modeem.addons.hw_drivers.main import iot_devices, manager
...
class ConnectionManager(Thread):
    ...
    def run(self):
        if not helpers.get_modeem_server_url() and not helpers.access_point():
    ...
    def _connect_box(self):
        ...
        try:
            ...
            req = requests.post('https://iot-proxy.modeem.com/modeem-enterprise/iot/connect-box', json=data, verify=False)
            ...
            _logger.error('Could not reach iot-proxy.modeem.com')
