...
from modeem.addons.hw_drivers.iot_handlers.drivers.SerialBaseDriver import SerialDriver, SerialProtocol, serial_connection


_logger = logging.getLogger(__name__)

# Only needed to ensure compatibility with older versions of Modeem
ACTIVE_SCALE = None
...
# Ensures compatibility with older versions of Modeem
