...
from modeem.addons.hw_drivers.iot_handlers.interfaces.PrinterInterface_L import PPDs, conn, cups_lock
...
class PrinterDriver(Driver):
    ...
    def send_status(self):
        """ Sends the current status of the printer to the connected Modeem instance.
        """
        self.data = {
            'value': '',
            'state': self.state,
