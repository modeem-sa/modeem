...
from modeem.tests.common import TransactionCase, users
...
from modeem.tools import mute_logger, convert_file
...
class TestSmsTemplateAccessRights(TransactionCase):
    ...
    @users('user_system')
    @mute_logger('modeem.models.unlink', 'modeem.addons.base.models.ir_model')
...
class TestSMSTemplateReset(TransactionCase):
    ...
    def test_sms_template_reset(self):
        ...
        self.assertEqual(sms_template.body.strip(), Markup('<div>Hello Modeem</div>'))
