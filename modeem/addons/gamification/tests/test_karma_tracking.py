...
from modeem import exceptions, fields
...
class TestKarmaTrackingCommon(common.TransactionCase):
    ...
    def test_consolidation_cron(self):
        self.patcher = patch('modeem.addons.gamification.models.gamification_karma_tracking.fields.Date', wraps=fields.Date)
...
class TestComputeRankCommon(common.TransactionCase):
    ...
    def setUpClass(cls):
        ...
        patch_email = patch('modeem.addons.mail.models.mail_template.MailTemplate.send_mail', _patched_send_mail)
    ...
    def test_02_update_rank_without_switch(self):
        ...
        patch_bulk = patch('modeem.addons.gamification.models.res_users.Users._recompute_rank', _patched_recompute_rank)
    ...
    def test_03_test_bulk_call(self):
        ...
        patch_bulk = patch('modeem.addons.gamification.models.res_users.Users._recompute_rank_bulk', _patched_check_in_bulk)
        self.startPatcher(patch_bulk)
