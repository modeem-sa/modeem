...
from modeem.addons.sale_loyalty.tests.common import TestSaleCouponNumbersCommon
from modeem.addons.website.tools import MockRequest
from modeem.addons.website_sale_loyalty.controllers.main import WebsiteSale
