...
from modeem.tests import HttpCase, tagged, TransactionCase
from modeem.addons.sale.tests.test_sale_product_attribute_value_config import TestSaleProductAttributeValueCommon
