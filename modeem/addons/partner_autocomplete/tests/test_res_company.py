...
from modeem.addons.partner_autocomplete.tests.common import MockIAPPartnerAutocomplete
...
class TestResCompany(common.TransactionCase, MockIAPPartnerAutocomplete):
    ...
    def test_extract_company_domain(self):
        ...
        company_1.website = "http://runbot.modeem.com"
        self.assertEqual(company_1._get_company_domain(), 'modeem.com')
