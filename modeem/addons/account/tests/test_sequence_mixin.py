...
from modeem.tests.common import Form, TransactionCase
from modeem import fields, api, SUPERUSER_ID
...
class TestSequenceMixin(TestSequenceMixinCommon):
    ...
    def test_journal_sequence(self):
        ...
        with Form(copy2) as move_form:  # It is editable in the form
            with mute_logger('modeem.tests.common.onchange'):
    ...
    def test_journal_sequence_ordering(self):
        ...
        with self.assertRaises(psycopg2.DatabaseError), mute_logger('modeem.sql_db'), self.env.cr.savepoint():
