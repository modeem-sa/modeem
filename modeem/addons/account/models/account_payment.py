# -*- coding: utf-8 -*-
from modeem import models, fields, api, _, Command
from modeem.exceptions import UserError, ValidationError
from modeem.tools.misc import format_date, formatLang
...
class AccountPayment(models.Model):
    ...
    payment_method_line_id = fields.Many2one('account.payment.method.line', string='Payment Method',
        ...
        help="Manual: Pay or Get paid by any method outside of Modeem.\n"
