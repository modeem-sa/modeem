# -*- coding: utf-8 -*-
from modeem import api, Command, fields, models, _
from modeem.osv import expression
from modeem.exceptions import UserError, ValidationError
from modeem.addons.base.models.res_bank import sanitize_account_number
from modeem.tools import remove_accents
import logging
import re
...
class AccountJournal(models.Model):
    ...
    invoice_reference_model = fields.Selection(string='Communication Standard', required=True, selection=[('modeem', 'Modeem'), ('euro', 'European')], default=_default_invoice_reference_model, help="You can choose different models for each type of reference. The default one is the Modeem reference.")
    ...
    inbound_payment_method_line_ids = fields.One2many(
        ...
        copy=False,
        check_company=True,
        help="Manual: Get paid by any method outside of Modeem.\n"
    ...
    outbound_payment_method_line_ids = fields.One2many(
        ...
        copy=False,
        check_company=True,
        help="Manual: Pay by any method outside of Modeem.\n"
        "Check: Pay bills by check and print it from Modeem.\n"
    ...
    alias_id = fields.Many2one('mail.alias', string='Email Alias', help="Send one separate email for each invoice.\n\n"
                                                                  ...
                                                                  "Only PDF and XML files will be interpreted by Modeem", copy=False)
