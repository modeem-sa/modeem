...
from modeem import api, fields, models, Command, _
from modeem.exceptions import ValidationError, UserError
from modeem.tools import frozendict, formatLang, format_date, float_compare, Query
from modeem.tools.sql import create_index
from modeem.addons.web.controllers.utils import clean_action

from modeem.addons.account.models.account_move import MAX_HASH_VERSION
...
class AccountMoveLine(models.Model):
    ...
    def _prepare_reconciliation_single_partial(self, debit_vals, credit_vals):
        ...
        if debit_vals['currency'] == credit_vals['currency'] == company_currency \
            ...
            debit_rate = get_modeem_rate(debit_vals)
            ...
            credit_rate = get_modeem_rate(credit_vals)
