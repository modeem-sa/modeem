...
from modeem import api, fields, models, _, Command
from modeem.addons.base.models.decimal_precision import DecimalPrecision
from modeem.addons.account.tools import format_rf_reference
from modeem.exceptions import UserError, ValidationError, AccessError, RedirectWarning
from modeem.tools import (
    date_utils,
    email_re,
    email_split,
    float_compare,
...
class AccountMove(models.Model):
    ...
    quick_edit_total_amount = fields.Monetary(
        ...
        help='Use this field to encode the total amount of the invoice.\n'
             'Modeem will automatically create one invoice line with default values to match it.',
    )
    ...
    def onchange(self, values, field_name, field_onchange):
        if field_name in ('line_ids', 'invoice_line_ids'):
            ...
            # File "/data/build/modeem/addons/account/models/account_move.py", line 2127, in onchange
            # del values[to_del]
            # KeyError: 'line_ids'
    ...
    def _get_invoice_reference_modeem_invoice(self):
        """ This computes the reference based on the Modeem format.
    ...
    def _get_invoice_reference_modeem_partner(self):
        """ This computes the reference based on the Modeem format.
    ...
    def _get_fields_to_copy_recurring_entries(self, values):
        ...
        values.update({
            ...
            'invoice_user_id': self.invoice_user_id.id,  # otherwise user would be ModeemBot
        })
    ...
    def _disable_discount_precision(self):
        ...
        with patch('modeem.addons.base.models.decimal_precision.DecimalPrecision.precision_get', new=precision_get):
            yield
