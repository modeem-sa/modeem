...
from modeem.tools import DEFAULT_SERVER_DATETIME_FORMAT, mute_logger
from modeem.exceptions import ValidationError, UserError
from modeem.addons.base.models.res_partner import WARNING_MESSAGE, WARNING_HELP
...
class ResPartner(models.Model):
    ...
    def _increase_rank(self, field, n=1):
        if self.ids and field in ['customer_rank', 'supplier_rank']:
            try:
                with self.env.cr.savepoint(flush=False), mute_logger('modeem.sql_db'):
                    query = sql.SQL("""
