...
from modeem import models, api, _, fields
from modeem.exceptions import UserError
from modeem.osv import expression
from modeem.release import version
from modeem.tools import DEFAULT_SERVER_DATE_FORMAT as DF
from modeem.tools.misc import formatLang, format_date as modeem_format_date, get_lang
import random
        ...
        for journal in self:
            ...
            for activity in self.env.cr.dictfetchall():
                act = {
                    ...
                    'date': modeem_format_date(self.env, activity.get('date_deadline'))
                }
