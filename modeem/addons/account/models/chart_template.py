...
from modeem import api, fields, models, Command, _, osv
from modeem import SUPERUSER_ID
from modeem.exceptions import UserError, ValidationError
from modeem.http import request
from modeem.addons.account.models.account_tax import TYPE_TAX_USE
from modeem.addons.account.models.account_account import ACCOUNT_CODE_REGEX
from modeem.tools import html_escape
...
def update_taxes_from_templates(cr, chart_template_xmlid):
    ...
    def _notify_accountant_managers(taxes_to_check):
        ...
        modeembot = env.ref('base.partner_root')
        message_body = _(
