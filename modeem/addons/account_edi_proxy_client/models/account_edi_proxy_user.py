...
from .account_edi_proxy_auth import ModeemEdiProxyAuth
...
DEFAULT_SERVER_URL = 'https://l10n-it-edi.api.modeem.com'
DEFAULT_TEST_SERVER_URL = 'https://iap-services-test.modeem.com'
TIMEOUT = 30
    ...
    def _make_request(self, url, params=False):
        ...
        try:
            response = requests.post(
                ...
                auth=ModeemEdiProxyAuth(user=self)).json()
