...
from modeem.addons.stock_account.tests.test_anglo_saxon_valuation_reconciliation_common import ValuationReconciliationTestCommon
from modeem.tests import common, Form
from modeem.exceptions import UserError
from modeem.tools import mute_logger, float_compare
from modeem.addons.stock_account.tests.test_stockvaluation import _create_accounting_data
...
class TestSaleMrpFlow(ValuationReconciliationTestCommon):
    ...
    @mute_logger('modeem.tests.common.onchange')
