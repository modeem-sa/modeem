...
from modeem.addons.sales_team.tests.common import TestSalesMC
from modeem.tests.common import users, TransactionCase
...
class TestCornerCases(TransactionCase):
    ...
    def test_unicity(self):
        ...
        with self.assertRaises(exceptions.UserError), mute_logger('modeem.sql_db'):
