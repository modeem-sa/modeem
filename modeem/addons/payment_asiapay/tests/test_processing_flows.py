...
from modeem.addons.payment_asiapay.controllers.main import AsiaPayController
...
class TestProcessingFlows(AsiaPayCommon, PaymentHttpCommon):
    ...
    @mute_logger('modeem.addons.payment_asiapay.controllers.main')
    def test_webhook_notification_triggers_processing(self):
        ...
        with patch(
            'modeem.addons.payment_asiapay.controllers.main.AsiaPayController.'
