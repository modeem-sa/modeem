...
from modeem.addons.payment_asiapay import const
from modeem.addons.payment_asiapay.tests.common import AsiaPayCommon
...
class TestPaymentTransaction(AsiaPayCommon, PaymentHttpCommon):
    ...
    def test_no_item_missing_from_rendering_values(self):
        ...
        with patch(
            'modeem.addons.payment_asiapay.models.payment_provider.PaymentProvider'
