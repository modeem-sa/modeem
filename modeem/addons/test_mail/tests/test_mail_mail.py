...
from modeem import api, Command, tools
from modeem.addons.base.models.ir_mail_server import MailDeliveryException
from modeem.addons.test_mail.tests.common import TestMailCommon
from modeem.exceptions import AccessError
from modeem.tests import common, tagged, users
from modeem.tools import mute_logger, DEFAULT_SERVER_DATETIME_FORMAT
...
class TestMailMail(TestMailCommon):
    ...
    def test_mail_mail_send_exceptions_origin(self):
        ...
        self._reset_data()
        with self.mock_mail_gateway(), mute_logger('modeem.addons.mail.models.mail_mail'):
        ...
        # Force catchall domain to void otherwise bounce is set to postmaster-modeem@domain
...
class TestMailMailRace(common.TransactionCase):
    ...
    def test_mail_bounce_during_send(self):
        ...
        def send_email(self, message, *args, **kwargs):
            with this.registry.cursor() as cr, mute_logger('modeem.sql_db'):
                try:
