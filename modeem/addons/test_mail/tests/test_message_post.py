...
from modeem.addons.base.tests.test_ir_cron import CronMixinCase
from modeem.addons.mail.tests.common import mail_new_test_user
from modeem.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE_PLAINTEXT
from modeem.addons.test_mail.models.test_mail_models import MailTestSimple
from modeem.addons.test_mail.tests.common import TestMailCommon, TestRecipients
from modeem.api import call_kw
from modeem.exceptions import AccessError
from modeem.tests import tagged
from modeem.tools import mute_logger, formataddr
...
class TestMailNotifyAPI(TestMessagePostCommon):
    ...
    @mute_logger('modeem.models.unlink')
    @users('employee')
...
class TestMessagePost(TestMessagePostCommon, CronMixinCase):
    ...
    @mute_logger('modeem.addons.mail.models.mail_mail', 'modeem.models.unlink')
    @users('employee')
    ...
    @mute_logger('modeem.addons.mail.models.mail_mail', 'modeem.models.unlink', 'modeem.tests')
    @users('employee')
    ...
    def test_message_post_inactive_follower(self):
        """ Test posting with inactive followers does not notify them (e.g. modeembot) """
        test_record = self.env['mail.test.simple'].browse(self.test_record.ids)
    ...
    @users('employee')
    @mute_logger('modeem.addons.mail.models.mail_mail', 'modeem.addons.mail.models.mail_message_schedule', 'modeem.models.unlink')
    ...
    @users('employee')
    @mute_logger('modeem.addons.mail.models.mail_mail', 'modeem.addons.mail.models.mail_message_schedule')
    ...
    @mute_logger('modeem.addons.mail.models.mail_mail', 'modeem.addons.mail.models.mail_thread')
    @users('employee')
...
class TestMessagePostHelpers(TestMessagePostCommon):
    ...
    @users('employee')
    @mute_logger('modeem.addons.mail.models.mail')
    ...
    @users('employee')
    @mute_logger('modeem.addons.mail.models.mail_mail', 'modeem.tests')
