...
from modeem import fields, exceptions, tests
...
from modeem.addons.test_mail.models.test_mail_models import MailTestActivity
from modeem.tools import mute_logger
from modeem.tests.common import Form, users
...
class TestActivityMixin(TestActivityCommon):
    ...
    def test_mail_activity_state(self):
        ...
        with patch('modeem.addons.mail.models.mail_activity.datetime', MockedDatetime):
    ...
    def test_mail_activity_mixin_search_state_basic(self):
        ...
        with patch('modeem.addons.mail.models.mail_activity.datetime', MockedDatetime), \
            patch('modeem.addons.mail.models.mail_activity_mixin.datetime', MockedDatetime):
