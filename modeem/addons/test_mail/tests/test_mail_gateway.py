...
from modeem import exceptions
from modeem.addons.mail.tests.common import mail_new_test_user
from modeem.addons.test_mail.data import test_mail_data
from modeem.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE
from modeem.addons.test_mail.models.test_mail_models import MailTestGateway
from modeem.addons.test_mail.tests.common import TestMailCommon
from modeem.sql_db import Cursor
from modeem.tests import tagged
from modeem.tests.common import users
from modeem.tools import email_split_and_format, formataddr, mute_logger
...
class TestEmailParsing(TestMailCommon):
    ...
    def test_message_parse_and_replace_binary_octetstream(self):
        ...
        with self.assertLogs('modeem.addons.mail.models.mail_thread', level="WARNING") as capture:
        ...
        self.assertEqual(capture.output, [
            ("WARNING:modeem.addons.mail.models.mail_thread:Message containing an unexpected "
    ...
    def test_message_parse_extract_bounce_rfc822_headers_qp(self):
        ...
        incoming_bounce = self.format(
            ...
            email_from='MAILER-DAEMON@mailserver.modeem.com (Mail Delivery System)',
            email_to='bounce@xxx.modeem.com',
            delivered_to='bounce@xxx.modeem.com'
        )
...
class TestMailAlias(TestMailCommon):
    ...
    @users('employee')
    @mute_logger('modeem.addons.base.models.ir_model')
...
class TestMailgateway(TestMailCommon):
    ...
    @mute_logger('modeem.addons.mail.models.mail_thread', 'modeem.models')
    ...
    @mute_logger('modeem.addons.mail.models.mail_thread')
    ...
    def test_message_process_followers(self):
        """ Incoming email: recognized author not archived and not modeembot:
        ...
        modeembot.active = True
        modeembot.email = 'modeembot@example.com'
        with self.mock_mail_gateway():
            record4 = self.format_and_process(
                MAIL_TEMPLATE, modeembot.email_formatted, 'groups@test.com',
                subject='Modeembot Automatic Answer')

        self.assertEqual(record4.message_ids[0].author_id, modeembot)
        self.assertEqual(record4.message_ids[0].email_from, modeembot.email_formatted)
        self.assertEqual(record4.message_follower_ids.partner_id, self.env['res.partner'],
                         'message_process: modeembot -> no follower')
    ...
    @mute_logger('modeem.addons.mail.models.mail_thread', 'modeem.models.unlink')
    ...
    @mute_logger('modeem.addons.mail.models.mail_thread', 'modeem.models.unlink', 'modeem.addons.mail.models.mail_mail')
    ...
    @mute_logger('modeem.addons.mail.models.mail_thread', 'modeem.addons.mail.models.mail_mail', 'modeem.models.unlink')
    ...
    @mute_logger('modeem.addons.mail.models.mail_thread', 'modeem.models.unlink', 'modeem.addons.mail.models.mail_mail', 'modeem.tests')
    ...
    def test_message_process_references_external(self):
        """ Incoming email being a reply to an external email processed by modeem should update thread accordingly """
    ...
    def test_message_process_references_external_buggy_message_id(self):
        ...
        modeem should update thread accordingly. Special case when the
    ...
    def test_message_process_extra_model_res_id(self):
        ...
        # Modeem 10 update: compat mode has been removed and should not work anymore
    ...
    @mute_logger('modeem.addons.mail.models.mail_thread', 'modeem.addons.mail.models.mail_mail')
    ...
    def test_routing_loop_alias(self):
        ...
        with self.mock_mail_gateway():
            self.format_and_process(
                ...
                extra='References: <test-1337-loop-detection-bounce-email@modeem.com>',
            )
