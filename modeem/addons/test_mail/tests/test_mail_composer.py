...
from modeem.addons.test_mail.models.test_mail_models import MailTestTicket
...
class TestComposerInternals(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('modeem.tests', 'modeem.addons.mail.models.mail_mail', 'modeem.models.unlink')
    ...
    @mute_logger('modeem.tests', 'modeem.addons.base.models.ir_rule', 'modeem.addons.mail.models.mail_mail', 'modeem.models.unlink')
...
class TestComposerResultsComment(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('modeem.models.unlink', 'modeem.addons.mail.models.mail_mail')
