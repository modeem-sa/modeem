...
from modeem.tools import is_html_empty, mute_logger, formataddr
from modeem.tests import tagged, users
...
class TestMessageAccess(TestMailCommon):
    ...
    @mute_logger('modeem.addons.base.models.ir_model', 'modeem.addons.base.models.ir_rule')
    ...
    def test_mail_message_access_create_wo_parent_access(self):
        ...
        partner_1 = self.env['res.partner'].create({
            'name': 'Jitendra Prajapati (jpr-modeem)',
            'email': 'jpr@modeem.com',
        })
