...
from modeem import api, models, _
...
class SurveyTemplate(models.Model):
    ...
    def action_load_sample_certification(self):
        survey_values = {
            ...
            'description': ''.join([
                _('Welcome to this Modeem certification. You will receive 2 random questions out of a pool of 3.'),
            ...
            'question_and_page_ids': [
                ...
                (0, 0, { # survey.question
                    'title': _('What does one need to get to pass an Modeem Survey?'),
                    'question_type': 'simple_choice',
                    'suggested_answer_ids': [
                        (0, 0, { # survey.question.answer
