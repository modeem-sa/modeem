...
from modeem.addons.website_sale_autocomplete.controllers.main import AutoCompleteController
from modeem.tests import patch, HttpCase, tagged

CONTROLLER_PATH = 'modeem.addons.website_sale_autocomplete.controllers.main.AutoCompleteController'
