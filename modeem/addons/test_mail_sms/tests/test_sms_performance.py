...
from modeem.addons.sms.tests import common as sms_common
from modeem.addons.test_mail.tests.test_performance import BaseMailPerformance
...
class TestSMSPerformance(BaseMailPerformance, sms_common.SMSCase):
    ...
    @mute_logger('modeem.addons.sms.models.sms_sms')
    @users('employee')
    @warmup
