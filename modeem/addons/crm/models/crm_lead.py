...
from modeem import api, fields, models, tools, SUPERUSER_ID
from modeem.addons.iap.tools import iap_tools
from modeem.addons.mail.tools import mail_validation
...
from modeem.tools import date_utils, email_re, email_split, is_html_empty, groupby
...
PLS_COMPUTE_BATCH_STEP = 50000  # modeem.models.PREFETCH_MAX = 1000 but larger cluster can speed up global computation
