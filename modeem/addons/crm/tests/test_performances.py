...
from modeem.addons.crm.tests.test_crm_lead_assignment import TestLeadAssignCommon
...
class TestLeadAssignPerf(TestLeadAssignCommon):
    ...
    @mute_logger('modeem.models.unlink', 'modeem.addons.crm.models.crm_team', 'modeem.addons.crm.models.crm_team_member')
