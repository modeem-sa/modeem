...
from modeem.addons.crm.models.crm_lead import PARTNER_ADDRESS_FIELDS_TO_SYNC
from modeem.addons.mail.tests.common import MailCase, mail_new_test_user
from modeem.addons.phone_validation.tools import phone_validation
from modeem.addons.sales_team.tests.common import TestSalesCommon
from modeem.fields import Datetime
from modeem import models, tools
...
class TestLeadConvertCommon(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.crm_lead_dt_patcher = patch('modeem.addons.crm.models.crm_lead.fields.Datetime', wraps=Datetime)
