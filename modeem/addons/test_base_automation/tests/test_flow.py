...
from modeem.tests import common, tagged
...
record['name'] = record.name + 'X'""",
    ...
    def test_11b_recomputed_field(self):
        ...
        patchers = [
            patch('modeem.addons.base_automation.models.base_automation.BaseAutomation._get_actions', _patched_get_actions),
            patch('modeem.addons.mail.models.mail_template.MailTemplate.send_mail', _patched_send_mail),
        ]
