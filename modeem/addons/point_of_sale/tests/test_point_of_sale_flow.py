...
from modeem.tools import float_compare, mute_logger, test_reports
from modeem.tests.common import Form
from modeem.addons.point_of_sale.tests.common import TestPointOfSaleCommon
...
class TestPointOfSaleFlow(TestPointOfSaleCommon):
    ...
    def test_create_from_ui(self):
        ...
        with mute_logger('modeem.addons.point_of_sale.models.pos_order'):
