...
wget 'https://nightly.modeem.com/master/iotbox/eftdvs' -P /usr/local/bin/
chmod +x /usr/local/bin/eftdvs
wget 'https://nightly.modeem.com/master/iotbox/eftapi.so' -P /usr/lib/

groupadd usbusers
usermod -a -G usbusers pi
usermod -a -G lp pi
usermod -a -G input lightdm
mkdir -v /var/log/modeem
chown pi:pi /var/log/modeem
chown pi:pi -R /home/pi/modeem/
...
echo "* * * * * rm /var/run/modeem/sessions/*" | crontab -
...
echo "addons/hw_drivers/iot_devices/" > /home/pi/modeem/.git/info/exclude
