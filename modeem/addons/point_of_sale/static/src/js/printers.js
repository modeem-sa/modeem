/* global html2canvas */
modeem.define('point_of_sale.Printer', function (require) {
"use strict";
        ...
        return new PrintResult({
            ...
            message: {
                ...
                body: _t('Please check if the printer is still connected. \n' +
                    ...
                    'If it is the case, you will need to follow Modeem\'s documentation for ' +
...
var PrinterMixin = {
    ...
    htmlToImg: function (receipt) {
        ...
        // Modeem RTL support automatically flip left into right but html2canvas
