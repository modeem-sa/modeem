modeem.define('point_of_sale.tour.ProductScreen', function (require) {
    'use strict';
...
modeem.define('point_of_sale.tour.FixedPriceNegativeQty', function (require) {
    'use strict';
...
modeem.define('point_of_sale.tour.OpenCloseCashCount', function (require) {
    'use strict';
