...
from modeem.osv.expression import AND
from modeem.addons.base.models.res_partner import _tz_get
from modeem.addons.calendar.models.calendar_attendee import Attendee
from modeem.addons.calendar.models.calendar_recurrence import (
    weekday_to_field,
...
from modeem.tools.misc import get_lang
from modeem.tools import pycompat, html2plaintext, is_html_empty, single_email_re
        ...
        for meeting in self:
            ...
            if meeting.alarm_ids:
                for alarm in meeting.alarm_ids:
                    ...
                    trigger.value = delta
                    valarm.add('DESCRIPTION').value = alarm.name or u'Modeem'
