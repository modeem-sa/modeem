modeem.define('pos_adyen.payment', function (require) {
"use strict";
...
var PaymentAdyen = PaymentInterface.extend({
    ...
    _handle_modeem_connection_failure: function (data) {
        // handle timeout
        var line = this.pending_adyen_line();
        if (line) {
            line.set_payment_status('retry');
        }
        this._show_error(_t('Could not connect to the Modeem server, please check your internet connection and try again.'));
    ...
    _call_adyen: function (data, operation) {
        return rpc.query({
            ...
            // before concluding Modeem is unreachable.
            timeout: 10000,
            shadow: true,
        }).catch(this._handle_modeem_connection_failure.bind(this));
    },
    ...
    _poll_for_response: function (resolve, reject) {
        ...
        return rpc.query({
            ...
            if (self.remaining_polls != 0) {
                ...
                return self._handle_modeem_connection_failure(data);
            }
