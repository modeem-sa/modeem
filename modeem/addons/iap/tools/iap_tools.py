...
from modeem import exceptions, _
from modeem.tests.common import BaseCase
from modeem.tools import email_normalize, pycompat

_logger = logging.getLogger(__name__)

DEFAULT_ENDPOINT = 'https://iap.modeem.com'
...
iap_patch = patch('modeem.addons.iap.tools.iap_tools.iap_jsonrpc', iap_jsonrpc_mocked)
...
_MAIL_DOMAIN_BLACKLIST = set([
    ...
    'wp.pl', 'hotmail.it', 'live.com.mx', 'zoho.com', 'live.co.uk', 'sohu.com', 'twoomail.com', 'yahoo.com.sg', 'modeem.com', 'yahoo.com.vn',
    ...
    'bk.ru', 'mail.modeem.com', 'gmail.con', 'fiu.edu', 'gmal.com', 'useemlikefun.com', 'google.com', 'trbvn.com', 'yopmail.com', 'ya.ru',
