...
from modeem.tests.common import TransactionCase, tagged
from modeem.addons.account.tests.common import AccountTestInvoicingCommon
from modeem.tools import DEFAULT_SERVER_DATETIME_FORMAT
...
class TestStockValuationWithCOA(AccountTestInvoicingCommon):
    ...
    def test_realtime_anglo_saxon_valuation_multicurrency_different_dates(self):
        ...
        def _today(*args, **kwargs):
            return date_po
        patchers = [
            patch('modeem.fields.Date.context_today', _today),
        ]
    ...
    def test_average_realtime_with_delivery_anglo_saxon_valuation_multicurrency_different_dates(self):
        ...
        patchers = [
            patch('modeem.fields.Date.context_today', _today),
            patch('modeem.fields.Datetime.now', _now),
        ]
