...
from modeem.addons.mail.tests.common import MailCase
from modeem.tests import tagged, Form, new_test_user
from modeem.tools import mute_logger, format_amount
