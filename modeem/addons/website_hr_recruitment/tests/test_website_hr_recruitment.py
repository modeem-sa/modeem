...
from modeem.api import Environment
import modeem.tests
from modeem.tools import html2plaintext

@modeem.tests.tagged('post_install', '-at_install')
class TestWebsiteHrRecruitmentForm(modeem.tests.HttpCase):
    def test_tour(self):
        ...
        with modeem.tests.RecordCapturer(self.env['hr.applicant'], []) as capt:
