...
from modeem.addons.payment_authorize.models.authorize_request import AuthorizeAPI
from modeem.addons.payment_authorize.const import TRANSACTION_STATUS_MAPPING
...
class PaymentTransaction(models.Model):
    ...
    def _send_refund_request(self, amount_to_refund=None):
        ...
        if tx_status in TRANSACTION_STATUS_MAPPING['voided']:
            ...
            # create a refund tx on Modeem to reflect the move of the funds.
