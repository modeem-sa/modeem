...
const VIEW_PREFIX = "modeem://view/";
const IR_MENU_ID_PREFIX = "modeem://ir_menu_id/";
const IR_MENU_XML_ID_PREFIX = "modeem://ir_menu_xml_id/";
...
export class ModeemMenuLinkCell extends LinkCell {
...
export class ModeemViewLinkCell extends LinkCell {
    /**
     *
     * @param {string} id
