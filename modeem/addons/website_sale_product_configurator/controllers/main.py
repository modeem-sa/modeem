...
from modeem.addons.sale_product_configurator.controllers.main import ProductConfiguratorController
from modeem.addons.website_sale.controllers import main
