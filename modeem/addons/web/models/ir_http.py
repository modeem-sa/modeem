...
import modeem
from modeem import api, http, models
from modeem.http import request
from modeem.tools import file_open, image_process, ustr
...
class Http(models.AbstractModel):
    ...
    def session_info(self):
        ...
        version_info = modeem.service.common.exp_version()
        ...
        session_info = {
            ...
            "support_url": "https://www.modeem.com/buy",
            "name": user.name,
            "username": user.login,
