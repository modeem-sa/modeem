...
class DataSet(http.Controller):
    ...
    def load(self, model, id, fields):
        warnings.warn("the route /web/dataset/load is deprecated and will be removed in Modeem 17. Use /web/dataset/call_kw with method 'read' and a list containing the id as args instead", DeprecationWarning)
        value = {}
    ...
    def call(self, model, method, args, domain_id=None, context_id=None):
        warnings.warn("the route /web/dataset/call is deprecated and will be removed in Modeem 17. Use /web/dataset/call_kw with empty kwargs instead", DeprecationWarning)
