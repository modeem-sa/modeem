...
from modeem.modules.module import get_manifest
...
class TestAssetsGenerateTimeCommon(modeem.tests.TransactionCase):
    ...
    def generate_bundles(self):
        ...
        for bundle in bundles:
            with mute_logger('modeem.addons.base.models.assetsbundle'):
...
@modeem.tests.tagged('post_install', '-at_install', 'assets_bundle')
...
@modeem.tests.tagged('post_install', '-at_install', '-standard', 'assets_bundle')
...
class TestLoad(HttpCase):
    def test_assets_already_exists(self):
        ...
        _save_attachment = modeem.addons.base.models.assetsbundle.AssetsBundle.save_attachment
        ...
        with patch('modeem.addons.base.models.assetsbundle.AssetsBundle.save_attachment', save_attachment):
