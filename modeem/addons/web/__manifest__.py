...

{
    ...
    'version': '1.0',
    'description': """
Modeem Web core module.
========================

This module provides the core of the Modeem Web Client.
""",
    'depends': ['base'],
    'auto_install': True,
    'data': [
    ...
    'assets': {
        ...
        'web.assets_common': [
            ...
            'web/static/lib/modeem_ui_icons/*',
            ...
            'web/static/src/legacy/scss/web.zoommodeem.scss',
            ...
            'web/static/lib/owl/modeem_module.js',
            ...
            'web/static/src/legacy/js/libs/zoommodeem.js',
