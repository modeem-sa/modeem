modeem.define('web.list_tests', function (require) {
"use strict";
...
const { _t } = core;
const { markup, onMounted, onWillUnmount, xml } = require("@modeem/owl");
...
QUnit.module('LegacyViews', {
        ...
        var list = await createView({
            ...
            mockRPC: function (route, args) {
                return this._super.apply(this, arguments).then(result => {
                    ...
                    // (see 5691b126f06/modeem/models.py#L2521-L2528)
        ...
        const list = await createView({
            ...
            mockRPC: function (route, args) {
                if (args.method === 'unlink') {
                    return Promise.reject({ message: "Modeem Server Error" });
                }
                return this._super(...arguments);
            },
        });
    ...
    QUnit.test('display a tooltip on a field', async function (assert) {
        ...
        var initialDebugMode = modeem.debug;
        modeem.debug = false;
