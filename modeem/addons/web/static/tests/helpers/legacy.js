modeem.define("web.SessionOverrideForTests", (require) => {
    // Override the Session.session_reload function
    // The wowl test infrastructure does set a correct modeem global value before each test
    // while the session is built only once for all tests.
    // So if a test does a session_reload, it will merge the modeem global of that test
...
modeem.define("web.test_legacy", async (require) => {
