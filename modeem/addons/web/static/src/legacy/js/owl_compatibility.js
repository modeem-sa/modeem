modeem.define('web.OwlCompatibility', function (require) {
    "use strict";
    ...
    /**
     * This file defines the necessary tools for the transition phase where Modeem
    ...
    const widgetSymbol = modeem.widgetSymbol;
     ...
     * adapter for Owl components that embed Modeem legacy widgets (or dynamically
     * both Owl components and Modeem legacy widgets), e.g.:
     *
     *                           Owl Component
     *                                 |
    ...
    class ComponentAdapter extends LegacyComponent {
        ...
        /**
         * Mocks _trigger_up to redirect Modeem legacy events to OWL events.
         *
         * @private
     ...
     * together when an Modeem legacy widget needs to instantiate Owl components.
    ...
    class ProxyComponent extends LegacyComponent {
         ...
         * Modeem legacy event. This function is called just before the event is
         * actually triggered.
         *
         * @private
         * @param {string} evType
