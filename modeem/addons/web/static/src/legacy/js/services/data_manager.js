modeem.define('web.DataManager', function (require) {
"use strict";
    ...
    load_views: async function ({ model, context, views_descr } , options = {}) {
        ...
        if (shouldLoadViews) {
            ...
            this._cache.views[viewsKey] = rpc.query({
                ...
                // utils.deepFreeze(result.fields); // OWL issue regarding proxies and frozen objects https://github.com/modeem/owl/issues/1158
...
modeem.define('web.data_manager', function (require) {
"use strict";
