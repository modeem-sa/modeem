/** @modeem-module alias=web.AbstractView **/

/**
 * This is the base class inherited by all (JS) views. Modeem JS views are the
 ...
 * the word 'view' has historical significance in Modeem code, so we replaced the
