/** @modeem-module alias=web.AbstractController **/

/**
 * The Controller class is the class coordinating the model and the renderer.
 * It is the C in MVC, and is what was formerly known in Modeem as a View.
 *
...
var AbstractController = mvc.Controller.extend(ActionMixin, {
    ...
    /**
     * When an Modeem event arrives requesting a record to be opened, this method
