modeem.define('web.relational_fields', function (require) {
"use strict";
...
var FieldMany2One = AbstractField.extend({
    ...
    */
     ...
     *
     * @param {ModeemEvent} event 'field_changed' event
     */
...
var FieldX2Many = AbstractField.extend(WidgetAdapterMixin, {
     ...
     * @override
     * @param {Object} record
     * @param {ModeemEvent} [ev] an event that triggered the reset action
...
var FieldOne2Many = FieldX2Many.extend({
     ...
     * @override
     * @private
     * @param {ModeemEvent|MouseEvent} ev this event comes either from the 'Add
