modeem.define('web.mixins', function (require) {
"use strict";
...
function ModeemEvent(target, name, data) {
    this.target = target;
    this.name = name;
...
ModeemEvent.prototype.stopPropagation = function () {
    this.stopped = true;
};

ModeemEvent.prototype.is_stopped = function () {
    return this.stopped;
};
...
var EventDispatcherMixin = _.extend({}, ParentedMixin, {
    ...
    trigger_up: function (name, info) {
        var event = new ModeemEvent(this, name, info);
