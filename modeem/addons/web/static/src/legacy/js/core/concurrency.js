modeem.define('web.concurrency', function (require) {
"use strict";
 ...
 * everything concurrency related in Modeem.
 *
 * The basic concurrency primitives in Modeem JS are the callback, and the
...
return {
    ...
    /**
     * A (Modeem) mutex is a primitive for serializing computations.  This is
