...
import { Component, onWillStart } from "@modeem/owl";
...
class ResConfigDevTool extends Component {
    setup() {
        this.isDebug = Boolean(modeem.debug);
        this.isAssets = modeem.debug.includes("assets");
        this.isTests = modeem.debug.includes("tests");
