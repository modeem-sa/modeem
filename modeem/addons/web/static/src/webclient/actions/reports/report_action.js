...
import { Component, useRef, useSubEnv } from "@modeem/owl";
 ...
 * It uses a feature to automatically create links to other modeem pages if the selector [res-id][res-model][view-type]
 * is detected.
 */
