...
import { Component, markup } from "@modeem/owl";
...
function documentationItem(env) {
    const documentationURL = "https://www.modeem.com/documentation/16.0";
    return {
        type: "item",
        id: "documentation",
...
function modeemAccountItem(env) {
    return {
        type: "item",
        id: "account",
        description: env._t("My Modeem.com account"),
        callback: () => {
            env.services
                ...
                .catch(() => {
                    browser.location.href = "https://accounts.modeem.com/account";
                });
        },
        sequence: 60,
    };
...
registry
    ...
    .add("modeem_account", modeemAccountItem)
