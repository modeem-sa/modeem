...
const modeemToBootstrapClasses = {
...
export class ViewButton extends Component {
    ...
    get hasBigTooltip() {
        return Boolean(modeem.debug) || this.clickParams.help;
    }
    ...
    getClassName() {
        ...
        if (this.props.className) {
            for (let cls of this.props.className.split(" ")) {
                if (cls in modeemToBootstrapClasses) {
                    cls = modeemToBootstrapClasses[cls];
                }
                classNames.push(cls);
