...
function () {
  ...
  _createClass(PDFSidebar, [{
    ...
    value: function setInitialView() {
      ...
      // Modeem: This change is needed here as we can't change this parameter in an iframe.
...
function getDefaultPreferences() {
  if (!defaultPreferences) {
    defaultPreferences = Promise.resolve({
      ...
      "enableWebGL": false,
      // Modeem: Below two preference changes are needed here as we can't change them as parameters in an iframe.
