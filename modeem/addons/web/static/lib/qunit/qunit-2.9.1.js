...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("ModeemBeforeTestHook", "ModeemAfterTestHook"); // Modeem customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("ModeemBeforeTestHook"); // Modeem customization
  	...
  	finish: function finish() {
        ...
        emit("ModeemAfterTestHook", this); // Modeem customization
