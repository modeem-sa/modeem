(function (exports) {
    ...
    function createCatcher(eventsSpec) {
        ...
        class VCatcher {
            ...
            moveBeforeVNode(other, afterNode) {
                if (other) {
                    // check this with @ged-modeem for use in foreach
...
See https://github.com/modeem/owl/blob/${hash}/doc/reference/app.md#configuration for more information.`;
    };
    ...
    __info__.url = 'https://github.com/modeem/owl';
