...
from modeem.tools import date_utils

from modeem import api, Command, fields, models, tools
from modeem.addons.base.models.res_partner import _tz_get
from modeem.addons.resource.models.resource import float_to_time, HOURS_PER_DAY
from modeem.exceptions import AccessError, UserError, ValidationError
from modeem.tools import float_compare, format_date
from modeem.tools.float_utils import float_round
from modeem.tools.misc import format_date
...
class HolidaysRequest(models.Model):
    ...
    def _check_allocation_duration(self):
        # Deprecated as part of https://github.com/modeem/modeem/pull/96545
        ...
        for holiday in holidays:
            if not self._context.get('leave_fast_create'):
                ...
                if holiday.validation_type == 'no_validation':
                    ...
                    holiday_sudo.message_post(body=_("The time off has been automatically approved"), subtype_xmlid="mail.mt_comment") # Message from ModeemBot (sudo)
