...
from modeem.tools import cleanup_xml_node
from modeem.tools.pdf import ModeemPdfFileReader, ModeemPdfFileWriter
        ...
        if collected_streams \
            ...
            if len(res_ids) == 1:
                ...
                if invoice.is_sale_document() \
                    ...
                    reader = ModeemPdfFileReader(reader_buffer, strict=False)

                    # Post-process and embed the additional files.
                    writer = ModeemPdfFileWriter()
