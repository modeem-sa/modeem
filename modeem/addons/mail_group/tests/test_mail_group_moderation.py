...
from modeem import Command, tools
from modeem.addons.mail_group.tests.data import GROUP_TEMPLATE
from modeem.addons.mail_group.tests.common import TestMailListCommon
...
class TestMailGroupModeration(TestMailListCommon):
    ...
    @mute_logger('modeem.models.unlink', 'modeem.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('modeem.addons.base.models.ir_rule', 'modeem.addons.base.models.ir_model')
...
class TestModeration(TestMailListCommon):
    ...
    @mute_logger('modeem.addons.mail.models.mail_thread', 'modeem.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('modeem.addons.mail.models.mail_thread', 'modeem.addons.mail_group.models.mail_group_message', 'modeem.models.unlink')
    @users('employee')
    ...
    @mute_logger('modeem.addons.mail_group.models.mail_group')
    @users('employee')
