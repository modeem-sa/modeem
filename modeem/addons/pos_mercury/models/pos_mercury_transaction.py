...
from modeem import models, api, service
from modeem.tools.translate import _
from modeem.exceptions import UserError
from modeem.tools import DEFAULT_SERVER_DATETIME_FORMAT, misc
...
class MercuryTransaction(models.Model):
    ...
    def _setup_request(self, data):
        ...
        data['memo'] = "Modeem " + service.common.exp_version()['server_version']
