modeem.define('pos_mercury.PaymentScreen', function (require) {
    'use strict';
    ...
    const PosMercuryPaymentScreen = (PaymentScreen) =>
        class extends PaymentScreen {
            setup() {
                ...
                // How long we wait for the modeem server to deliver the response of
                ...
                this.rpc(
                    ...
                    .then(function (data) {
                        ...
                        if (data === 'internal error') {
                            def.resolve({
                                message: self.env._t('Modeem error while processing transaction.'),
                            });
                            return;
                        }
