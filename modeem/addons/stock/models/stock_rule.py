...
from modeem import SUPERUSER_ID, _, api, fields, models, registry
from modeem.exceptions import UserError
from modeem.osv import expression
from modeem.tools import float_compare, float_is_zero, html_escape
from modeem.tools.misc import split_every
...
class StockRule(models.Model):
    ...
    def _get_lead_days(self, product, **values):
        ...
        :type product: :class:`~modeem.addons.product.models.product.ProductProduct`
...
class ProcurementGroup(models.Model):
    ...
    def run(self, procurements, raise_user_error=True):
        ...
        :type list: list of `~modeem.addons.stock.models.stock_rule.ProcurementGroup.Procurement`
