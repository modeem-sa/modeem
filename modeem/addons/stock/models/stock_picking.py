...
from modeem import SUPERUSER_ID, _, api, fields, models
from modeem.addons.stock.models.stock_move import PROCUREMENT_PRIORITIES
from modeem.exceptions import UserError, ValidationError
from modeem.osv import expression
from modeem.tools import DEFAULT_SERVER_DATETIME_FORMAT, format_datetime, format_date, groupby
from modeem.tools.float_utils import float_compare, float_is_zero, float_round
...
class PickingType(models.Model):
    ...
    show_reserved = fields.Boolean(
        ...
        help="If this checkbox is ticked, Modeem will automatically pre-fill the detailed "
    ...
    auto_show_reception_report = fields.Boolean(
        ...
        help="If this checkbox is ticked, Modeem will automatically show the reception report (if there are moves to allocate to) when validating.")
