...
function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('modeem-google-map'), {
        zoom: 1,
    ...
    if (modeem_partner_data){ /* modeem_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < modeem_partner_data.counter; i++) {
            set_marker(modeem_partner_data.partners[i]);
        }
