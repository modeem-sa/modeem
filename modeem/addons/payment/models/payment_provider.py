...
class PaymentProvider(models.Model):
    ...
    capture_manually = fields.Boolean(
        ...
        help="Capture the amount from Modeem, when the delivery is completed.\n"
    ...
    module_to_buy = fields.Boolean(string="Modeem Enterprise Module", related='module_id.to_buy')
