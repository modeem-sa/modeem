...
from modeem.addons.event_booth_sale.tests.common import TestEventBoothSaleCommon
from modeem.addons.website_event_sale.tests.common import TestWebsiteEventSaleCommon
from modeem.addons.website_sale.controllers.main import WebsiteSale
