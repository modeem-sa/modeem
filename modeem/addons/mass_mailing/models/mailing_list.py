...
from modeem import _, Command, fields, models
...
class MassMailingList(models.Model):
    ...
    def action_merge(self, src_lists, archive):
        ...
        # A (id=4): yti@modeem.com; yti@example.com
        # B (id=5): yti@modeem.com; yti@openerp.com
        # C (id=6): nothing
        ...
        # ------------+---------------------------+------------------------
        #           4 | yti@modeem.com              |          1 |        4 |
        #           6 | yti@modeem.com              |          2 |        5 |
