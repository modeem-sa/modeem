...
from modeem.addons.test_mass_mailing.data.mail_test_data import MAIL_TEMPLATE
from modeem.addons.test_mass_mailing.tests.common import TestMassMailCommon
...
class TestMailingStatistics(TestMassMailCommon):
    ...
    @mute_logger('modeem.addons.mass_mailing.models.mailing', 'modeem.addons.mail.models.mail_mail', 'modeem.addons.mail.models.mail_thread')
    def test_mailing_statistics(self):
        ...
        self.gateway_mail_click(mailing, target_records[0], 'https://www.modeem.be')
        self.gateway_mail_click(mailing, target_records[2], 'https://www.modeem.be')
        self.gateway_mail_click(mailing, target_records[3], 'https://www.modeem.be')
