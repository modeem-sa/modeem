...
from modeem.addons.mass_mailing_sms.tests.common import MassSMSCommon
from modeem.addons.test_mail_sms.tests.common import TestSMSCommon
...
<t t-set="httpurl" t-value="'https://www.modeem.eu'"/>f
<span>Website0: <a id="url0" t-attf-href="https://www.modeem.tz/my/{{object.name}}">https://www.modeem.tz/my/<t t-out="object.name"/></a></span>
<span>Website1: <a id="url1" href="https://www.modeem.be">https://www.modeem.be</a></span>
...
<span>Email: <a id="url7" href="mailto:test@modeem.com">test@modeem.com</a></span>
<p>Stop spam ? <a id="url8" role="button" href="/unsubscribe_from_list">Ok</a></p>
        ...
        cls.mailing_sms = cls.env['mailing.mailing'].with_user(cls.user_marketing).create({
            ...
            'body_plaintext': 'Dear {{object.display_name}} this is a mass SMS with two links http://www.modeem.com/smstest and http://www.modeem.com/smstest/{{object.id}}',
            'sms_force_send': True,
