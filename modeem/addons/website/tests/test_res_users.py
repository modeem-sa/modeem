...
from modeem.tests.common import TransactionCase, new_test_user
from modeem.exceptions import ValidationError
from modeem.tools import mute_logger
from modeem.service.model import retrying
...
class TestWebsiteResUsers(TransactionCase):
    ...
    def test_same_website_message(self):
        ...
        with TestCase.assertRaises(self, ValidationError), mute_logger('modeem.sql_db'):
