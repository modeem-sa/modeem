modeem.define("website.tour.edit_megamenu", function (require) {
"use strict";
...
wTourUtils.registerWebsitePreviewTour('edit_megamenu', {
    ...
    toggleMegaMenu({extra_trigger: 'iframe #top_menu .nav-item a.o_mega_menu_toggle:contains("Megaaaaa!")'}),
    {
        ...
        trigger: 'iframe .s_mega_menu_modeem_menu .row > div:first-child .nav > :nth-child(6)', // 6th is the last one
    },
    {
    ...
    },
    {
        ...
        trigger: 'iframe .s_mega_menu_modeem_menu .row > div:first-child .nav:not(:has(> :nth-child(6)))',
        run: () => null,
    },
    {
