modeem.define('website.tour.form_editor', function (require) {
    'use strict';
    ...
    wTourUtils.registerWebsitePreviewTour("website_form_editor_tour", {
        ...
        ...addExistingField('email_cc', 'text', 'Test conditional visibility', false, {visibility: CONDITIONALVISIBILITY, condition: 'modeem'}),
...

        {
            ...
            run: () => {
                ...
                wysiwyg.modeemEditor.historyStep(true);
            },
        },
