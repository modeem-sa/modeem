...
wTourUtils.registerWebsitePreviewTour('snippet_social_media', {
    ...
    ...addNewSocialNetwork(8, 7, 'https://instagr.am/modeem.official/'),
    {
        ...
        trigger: "iframe .s_social_media" +
                 ...
                 ":has(a:eq(7)[href='https://instagr.am/modeem.official/']:has(i.fa-instagram))",
        run: () => {}, // This is a check.
    },
    ...
    },
    {
        ...
        run: 'text https://instagram.com/modeem.official/',
    },
    {
        content: 'Save',
