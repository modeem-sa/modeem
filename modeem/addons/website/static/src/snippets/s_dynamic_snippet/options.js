modeem.define('website.s_dynamic_snippet_options', function (require) {
'use strict';
...
const dynamicSnippetOptions = options.Class.extend({
    ...
    async _setOptionsDefaultValues() {
        ...
        this.options.wysiwyg.modeemEditor.observerUnactive();
        ...
        this.options.wysiwyg.modeemEditor.observerActive();
    },
    /**
