modeem.define('website.snippet.editor', function (require) {
'use strict';
...
const ModeemEditorLib = require('@web_editor/js/editor/modeem-editor/src/utils/utils');
const getDeepRange = ModeemEditorLib.getDeepRange;
const getTraversedNodes = ModeemEditorLib.getTraversedNodes;
...
const wSnippetMenu = weSnippetEditor.SnippetsMenu.extend({
    ...
    _toggleAnimatedTextButton() {
        const sel = this.options.wysiwyg.modeemEditor.document.getSelection();
    ...
    _onAnimateTextClick(ev) {
        ...
        if (this.$currentAnimatedText.length) {
            ...
            this.options.wysiwyg.modeemEditor.historyResetLatestComputedSelection();
            this._toggleHighlightAnimatedTextButton();
