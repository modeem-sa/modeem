modeem.define('website.editor.snippets.options', function (require) {
'use strict';
...
options.registry.OptionsTab = options.Class.extend({
    ...
    async updateUI() {
        ...
        // If the gray palette has been generated by Modeem standard option,
        ...
        // same hue by the Modeem editor, there might be rounding errors
