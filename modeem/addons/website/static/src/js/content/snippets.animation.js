modeem.define('website.content.snippets.animation', function (require) {
'use strict';
...
registry.slider = publicWidget.Widget.extend({
    ...
    _computeHeights: function () {
        ...
        _.each($items, el => {
            ...
            this.options.wysiwyg && this.options.wysiwyg.modeemEditor.observerUnactive('_computeHeights');
            $item.addClass('active');
            this.options.wysiwyg && this.options.wysiwyg.modeemEditor.observerActive('_computeHeights');
...
registry.mediaVideo = publicWidget.Widget.extend(MobileYoutubeAutoplayMixin, {
    ...
    start: function () {
        ...
        // integrated with Modeem (this refactoring should be done in master).
        ...
        // videos added before bug fixes or new Modeem versions where the
 ...
 * shapes in future Modeem versions.
 *
 * /!\
