modeem.define('website.content.menu', function (require) {
'use strict';
...
const BaseAnimatedHeader = animations.Animation.extend({
    ...
    start: function () {
        ...
        // transitionstart, so we listen to a custom modeem event.
        this._transitionCount = 0;
        this.$el.on('modeem-transitionstart.BaseAnimatedHeader', () => {
    ...
    _adaptToHeaderChange: function () {
        this.options.wysiwyg && this.options.wysiwyg.modeemEditor.observerUnactive();
        ...
        this.options.wysiwyg && this.options.wysiwyg.modeemEditor.observerActive();
    },
    /**
     * @private
    ...
    _updateHeaderOnScroll: function (scroll) {
        ...
        if (this.headerIsScrolled !== headerIsScrolled) {
            ...
            if (!this.scrollHeightTooShort) {
                ...
                this.$el.trigger('modeem-transitionstart');
