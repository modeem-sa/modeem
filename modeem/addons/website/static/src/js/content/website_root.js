/** @modeem-module alias=website.root */
...
export const WebsiteRoot = publicRootData.PublicRoot.extend(KeyboardNavigationMixin, {
    ...
    start: function () {
        ...
        this.$('.zoomable img[data-zoom]').zoomModeem();
    ...
    async _loadGMapAPI(editableMode, refetch) {
        ...
        if (refetch || !this._gmapAPILoading) {
            this._gmapAPILoading = new Promise(async resolve => {
                ...
                window.modeem_gmap_api_post_load = (async function modeem_gmap_api_post_load() {
                ...
                await loadJS(`https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&callback=modeem_gmap_api_post_load&key=${key}`);
            });
        }
