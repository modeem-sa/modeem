...
from modeem import api, fields, models, tools, http, release, registry
from modeem.addons.http_routing.models.ir_http import RequestUID, slugify, url_for
from modeem.addons.website.models.ir_http import sitemap_qs2dom
from modeem.addons.website.tools import similarity_score, text_from_html
from modeem.addons.portal.controllers.portal import pager
from modeem.addons.iap.tools import iap_tools
from modeem.exceptions import AccessError, MissingError, UserError, ValidationError
from modeem.http import request
from modeem.modules.module import get_resource_path, get_manifest
from modeem.osv.expression import AND, OR, FALSE_DOMAIN, get_unaccent_wrapper
from modeem.tools.translate import _
from modeem.tools import escape_psql, OrderedSet, pycompat
...
DEFAULT_ENDPOINT = 'https://website.api.modeem.com'
