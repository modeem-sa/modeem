...
from modeem.osv.expression import FALSE_DOMAIN
from modeem.addons.http_routing.models import ir_http
from modeem.addons.http_routing.models.ir_http import _guess_mimetype
...
def get_request_website():
    ...
    ```
    from modeem.addons.website.models import ir_http
...
class Http(models.AbstractModel):
    ...
    def _get_translation_frontend_modules_name(cls):
        ...
        installed = request.registry._init_modules.union(modeem.conf.server_wide_modules)
