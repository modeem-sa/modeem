...
from modeem import http, models, fields, _
from modeem.exceptions import AccessError
from modeem.http import request, SessionExpiredException
from modeem.osv import expression
from modeem.tools import OrderedSet, escape_psql, html_escape as escape
from modeem.addons.http_routing.models.ir_http import slug, slugify, _guess_mimetype
from modeem.addons.portal.controllers.portal import pager as portal_pager
from modeem.addons.portal.controllers.web import Home
from modeem.addons.web.controllers.binary import Binary
...
class Website(Home):
    ...
    def website_info(self, **kwargs):
        ...
        values = {
            'apps': apps,
            'l10n': l10n,
            'version': modeem.service.common.exp_version()
        }
