...
from modeem.addons.website_slides.tests.test_ui_wslides import TestUICommon
...
class TestUi(TestUICommon):
    ...
    def test_course_certification_employee(self):
        ...
        self.browser_js(
            '/slides',
            'modeem.__DEBUG__.services["web_tour.tour"].run("certification_member")',
            'modeem.__DEBUG__.services["web_tour.tour"].tours.certification_member.ready',
