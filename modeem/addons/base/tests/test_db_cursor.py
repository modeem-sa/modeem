...
def registry():
    return modeem.registry(common.get_db_name())
...
class TestTestCursor(common.TransactionCase):
    def setUp(self):
        ...
        self.env = modeem.api.Environment(self.cr, modeem.SUPERUSER_ID, {})
    ...
    def test_interleaving(self):
        ...
        with self.assertLogs('modeem.sql_db', level=logging.WARNING) as cm:
            a.close()
        [msg] = cm.output
        self.assertIn('WARNING:modeem.sql_db:Found different un-closed cursor', msg)
