...
from modeem.addons.base.tests import test_mail_examples
...
class TestIrMailServer(TransactionCase, MockSmtplibCase):
    ...
    def test_mail_server_priorities(self):
        ...
        # remove the notifications email to simulate a mis-configured Modeem database
        ...
        with mute_logger('modeem.addons.base.models.ir_mail_server'):
    ...
    def test_mail_server_binary_arguments_domain(self):
        """Test the configuration provided in the modeem-bin arguments.
        ...
        # Remove all mail server so we will use the modeem-bin arguments
    ...
    def test_mail_server_mail_default_from_filter(self):
        """Test that the config parameter "mail.default.from_filter" overwrite the modeem-bin
