...
from modeem.addons.base.models.res_users import is_selection_groups, get_selection_groups, name_selection_groups
from modeem.exceptions import UserError
from modeem.tests.common import TransactionCase, Form, tagged, new_test_user
...
class TestUsers(TransactionCase):
    ...
    def test_context_get_lang(self):
        ...
        request_patch = patch('modeem.addons.base.models.res_users.request', request)
