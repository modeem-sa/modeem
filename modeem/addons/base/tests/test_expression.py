...
from modeem.addons.base.tests.common import SavepointCaseWithUserDemo
from modeem.fields import Date
...
class TestExpression(SavepointCaseWithUserDemo):
    ...
    def test_10_hierarchy_in_m2m(self):
        ...
        with self.assertLogs('modeem.osv.expression'):
    ...
    def test_accent(self):
        ...
        with patch('modeem.osv.expression.get_unaccent_wrapper') as w:
