...
from modeem import SUPERUSER_ID, Command
from modeem.exceptions import RedirectWarning, UserError, ValidationError
from modeem.tests.common import TransactionCase, BaseCase
from modeem.tools import mute_logger
from modeem.tools.safe_eval import safe_eval, const_eval, expr_eval
...
class TestSafeEval(BaseCase):
    ...
    @mute_logger('modeem.tools.safe_eval')
    def test_05_safe_eval_forbiddon(self):
        ...
        with self.assertRaises(ValueError):
            safe_eval("import modeem", mode="exec")
