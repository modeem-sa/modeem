...
from modeem.modules import get_module_resource
from modeem.tests.common import TransactionCase
from modeem.addons.base.models.ir_qweb import QWebException, render
from modeem.tools import misc, mute_logger
from modeem.tools.json import scriptsafe as json_scriptsafe
from modeem.exceptions import UserError, ValidationError, MissingError
...
class TestQWebNS(TransactionCase):
    ...
    def test_render_dynamic_xml_with_code_error(self):
        ...
        view1 = self.env['ir.ui.view'].create({
            ...
            'arch': """
                <t t-name="base.dummy">
                    <Invoice xmlns:od="http://modeem.com/od">
...
class TestQWebBasic(TransactionCase):
    ...
    def test_attf_escaping_2(self):
        ...
        result = """
                <a href="/link/modeem/sub">link</a>
                <a href="/link/modeem/">link2</a>
            """
        values = {'url': 'modeem', 'other': True}
        rendered = self.env['ir.qweb']._render(t.id, values)
        self.assertEqual(rendered.strip(), result.strip())
    ...
    @mute_logger('modeem.addons.base.models.ir_qweb') # warning for template not found
...
class TestQWebStaticXml(TransactionCase):
    ...
    @mute_logger('modeem.addons.base.models.ir_qweb') # tests t-raw which is deprecated
