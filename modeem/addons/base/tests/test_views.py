...
from modeem.tools import mute_logger, view_validation
from modeem.addons.base.models.ir_ui_view import (
...
class ViewCase(common.TransactionCase):
    ...
    def assertInvalid(self, arch, expected_message=None, name='invalid view', inherit_id=False):
        with mute_logger('modeem.addons.base.models.ir_ui_view'):
    ...
    def assertWarning(self, arch, expected_message=None, name='invalid view'):
        with self.assertLogs('modeem.addons.base.models.ir_ui_view', level="WARNING") as log_catcher:
            self.View.create({
                'name': name,
                'model': 'ir.ui.view',
                'arch': arch,
...
class TestApplyInheritanceSpecs(ViewCase):
    ...
    @mute_logger('modeem.addons.base.models.ir_ui_view')
