...
import modeem
from modeem import api, http, models, tools, SUPERUSER_ID
from modeem.exceptions import AccessDenied, AccessError, MissingError
from modeem.http import request, Response, ROUTING_KEYS, Stream
from modeem.modules.registry import Registry
from modeem.service import security
from modeem.tools import consteq, submap
...
class IrHttp(models.AbstractModel):
    ...
    def routing_map(cls, key=None):
        ...
        if key not in cls._routing_map:
            ...
            installed = registry._init_modules.union(modeem.conf.server_wide_modules)
            if tools.config['test_enable'] and modeem.modules.module.current_test:
                installed.add(modeem.modules.module.current_test)
