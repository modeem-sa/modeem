...
from modeem.tools import ustr, OrderedSet
from modeem.tools.translate import code_translations, _lt
...
class IrFieldsConverter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str):
        ...
        callable taking a record-ish (a dictionary representing an modeem
        record with values of typetag ``fromtype``) and returning a converted
        records matching what :meth:`modeem.osv.orm.Model.write` expects.

        :param model: :class:`modeem.osv.orm.Model` for the conversion base
        :param fromtype:
    ...
    def to_field(self, model, field, fromtype=str):
        ...
        :type field: :class:`modeem.fields.Field`
