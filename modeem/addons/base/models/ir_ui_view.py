...
from modeem.exceptions import ValidationError, AccessError, UserError
from modeem.http import request
from modeem.modules.module import get_resource_from_path, get_resource_path
from modeem.tools import config, ConstantMapping, get_diff, pycompat, apply_inheritance_specs, locate_node, str2bool
from modeem.tools.convert import _fix_multiple_roots
from modeem.tools import safe_eval, lazy, lazy_property, frozendict
from modeem.tools.view_validation import valid_view, get_variable_names, get_domain_identifiers, get_dict_asts
from modeem.tools.translate import xml_translate, TRANSLATED_ATTRS
from modeem.models import check_method_name
from modeem.osv.expression import expression
...
@lazy
def keep_query():
    mod = modeem.addons.base.models.ir_qweb
...
class Model(models.AbstractModel):
    ...
    def fields_view_get(self, view_id=None, view_type='form', toolbar=False, submenu=False):
        ...
        .. deprecated:: saas-15.4
            ...
            Use :meth:`~modeem.models.Model.get_view()` instead.
        """
        warnings.warn(
