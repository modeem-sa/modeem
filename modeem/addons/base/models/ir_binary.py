...
from modeem.exceptions import MissingError, UserError
from modeem.http import Stream, request
from modeem.tools import file_open, replace_exceptions
from modeem.tools.image import image_process, image_guess_size_from_field_name
from modeem.tools.mimetypes import guess_mimetype, get_extension
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:modeem.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~modeem.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`modeem.tools.image.image_process`.
