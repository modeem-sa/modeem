...
from modeem.exceptions import AccessError, ValidationError
...
class IrRule(models.Model):
    ...
    def write(self, vals):
        ...
        # DLE P33: tests
        # - modeem/addons/test_access_rights/tests/test_feedback.py
        # - modeem/addons/test_access_rights/tests/test_ir_rules.py
        # - modeem/addons/base/tests/test_orm.py (/home/dle/src/modeem/master-nochange-fp/modeem/addons/base/tests/test_orm.py)
        self.env.flush_all()
        self.clear_caches()
        return res
