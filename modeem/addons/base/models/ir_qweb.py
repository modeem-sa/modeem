...
QWeb is the primary templating engine used by Modeem. It is an XML templating
...
<https://www.modeem.com/documentation/16.0/developer/reference/frontend/qweb.html>`
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
**Values**: name of the allowed modeem user group, or preceded by ``!`` for
prohibited groups

The generated code uses ``user_has_groups`` Modeem method.
...
from modeem import api, models, tools
from modeem.tools import config, safe_eval, pycompat, SUPPORTED_DEBUGGER
from modeem.tools.safe_eval import assert_valid_codeobj, _BUILTINS, to_opcodes, _EXPR_OPCODES, _BLACKLIST
from modeem.tools.json import scriptsafe
from modeem.tools.misc import str2bool
from modeem.tools.image import image_data_uri
from modeem.http import request
from modeem.modules.module import get_resource_path, get_module_path
from modeem.tools.profiler import QwebTracker
from modeem.exceptions import UserError, AccessDenied, AccessError, MissingError, ValidationError

from modeem.addons.base.models.assetsbundle import AssetsBundle
from modeem.addons.base.models.ir_asset import can_aggregate, STYLE_EXTENSIONS, SCRIPT_EXTENSIONS, TEMPLATE_EXTENSIONS
