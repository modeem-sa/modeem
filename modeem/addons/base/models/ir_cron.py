...
BASE_VERSION = modeem.modules.get_manifest('base')['version']
...
class ir_cron(models.Model):
        ...
        try:
            ...
            with db.cursor() as cron_cr:
                ...
                for job_id in (job['id'] for job in jobs):
                    ...
                    registry = modeem.registry(db_name)
    ...
    def _check_modules_state(cls, cr, jobs):
        ...
        # reset_module_states.
        modeem.modules.reset_modules_state(cr.dbname)
    ...
    def _callback(self, cron_name, server_action_id, job_id):
        ...
        try:
            ...
            modeem.netsvc.log(_logger, logging.DEBUG, 'cron.object.execute', (self._cr.dbname, self._uid, '*', cron_name, server_action_id), depth=log_depth)
            start_time = False
    ...
    def _notifydb(self):
        ...
        """
        with modeem.sql_db.db_connect('postgres').cursor() as cr:
