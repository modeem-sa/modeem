...
from modeem.addons.payment_payumoney.controllers.main import PayUMoneyController
from modeem.addons.payment_payumoney.tests.common import PayumoneyCommon
...
class PayUMoneyTest(PayumoneyCommon, PaymentHttpCommon):
    ...
    @mute_logger('modeem.addons.payment_payumoney.controllers.main')
