...
from modeem import _, fields, models
...
from modeem.addons.payment_stripe.const import STATUS_MAPPING, PAYMENT_METHOD_TYPES
    ...
    def _stripe_create_customer(self):
        ...
        customer = self.provider_id._stripe_make_request(
            'customers', payload={
                ...
                'description': f'Modeem Partner: {self.partner_id.name} (id: {self.partner_id.id})',
