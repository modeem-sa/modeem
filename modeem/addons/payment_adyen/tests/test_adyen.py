...
from modeem.addons.payment_adyen.controllers.main import AdyenController
from modeem.addons.payment_adyen.tests.common import AdyenCommon
...
class AdyenTest(AdyenCommon, PaymentHttpCommon):
    ...
    @mute_logger('modeem.addons.payment_adyen.models.payment_transaction')
    def test_send_refund_request(self):
        ...
        with patch(
            'modeem.addons.payment_adyen.models.payment_provider.PaymentProvider._adyen_make_request',
    ...
    @mute_logger('modeem.addons.payment_adyen.controllers.main')
    @mute_logger('modeem.addons.payment_adyen.models.payment_transaction')
    def _webhook_notification_flow(self, payload):
        ...
        with patch(
            'modeem.addons.payment_adyen.controllers.main.AdyenController'
