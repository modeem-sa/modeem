...
import modeem
from modeem import api, models, exceptions, tools, http
from modeem.addons.base.models import ir_http
from modeem.addons.base.models.ir_http import RequestUID
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        if request.is_frontend_multilang:
            ...
            if request.httprequest.method in ('GET', 'HEAD'):
                ...
                except modeem.exceptions.MissingError:
