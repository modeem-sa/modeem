...
from modeem import _, api, fields, models, service
from modeem.exceptions import ValidationError

from modeem.addons.payment_mollie.const import SUPPORTED_CURRENCIES
...
class PaymentProvider(models.Model):
    ...
    def _mollie_make_request(self, endpoint, data=None, method='POST'):
        ...
        modeem_version = service.common.exp_version()['server_version']
        ...
        headers = {
            ...
            "User-Agent": f'Modeem/{modeem_version} MollieNativeModeem/{module_version}',
        }
