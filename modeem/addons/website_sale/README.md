...
Modeem is an <a href="https://www.modeem.com/app/ecommerce">Open Source eCommerce</a>
...
Modeem's unique *'edit inline'* and building blocks approach makes product pages
...
Modeem's upselling algorythm allows you to show visitors similar but more
...
Get a clear visibility of your sales funnel. Modeem's Google Analytics trackers
are configured by default to track all kind of events related to shopping
carts, call-to-actions, etc.

As Modeem marketing tools (mass mailing, campaigns, etc) are also linked with
Google Analytics, you get a complete view of your business.

Target New Markets
------------------

Get your website translated in multiple languages with no effort. Modeem proposes
...
SEO tools are ready to use, with no configuration required. Modeem suggests
...
Create new landing pages easily with the Modeem inline editing feature. Send
...
Benefit from the power of Modeem, in your online store: a powerfull tax engine,
...
Everything is integrated with Modeem. No pain, real time.
