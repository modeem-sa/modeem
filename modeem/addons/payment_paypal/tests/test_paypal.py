...
from modeem.addons.payment_paypal.controllers.main import PaypalController
from modeem.addons.payment_paypal.tests.common import PaypalCommon
...
class PaypalTest(PaypalCommon, PaymentHttpCommon):
    ...
    @mute_logger('modeem.addons.payment_paypal.controllers.main')
    def test_webhook_notification_confirms_transaction(self):
        """ Test the processing of a webhook notification. """
        tx = self._create_transaction('redirect')
        url = self._build_url(PaypalController._webhook_url)
        with patch(
            'modeem.addons.payment_paypal.controllers.main.PaypalController'
