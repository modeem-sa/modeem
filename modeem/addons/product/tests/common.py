...
from modeem.addons.base.tests.common import BaseCommon
from modeem.addons.uom.tests.common import UomCommon
...
class ProductCommon(
    ...
    def _archive_other_pricelists(cls):
        ...
        if website_sale.state == 'installed':
            archive_context = patch('modeem.addons.website_sale.models.product_pricelist.ProductPricelist._check_website_pricelist')
        else:
