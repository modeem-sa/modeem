...
from modeem.addons.payment_razorpay.const import PAYMENT_STATUS_MAPPING
from modeem.addons.payment_razorpay.controllers.main import RazorpayController
from modeem.addons.phone_validation.tools.phone_validation import phone_sanitize_numbers
...
class PaymentTransaction(models.Model):
    ...
    def _send_void_request(self):
        ...
        raise UserError(_("Transactions processed by Razorpay can't be manually voided from Modeem."))
    ...
    def _get_tx_from_notification_data(self, provider_code, notification_data):
        ...
        if entity_type == 'payment':
            ...
            if reference:  # The refund was initiated from Modeem.
                tx = self.search([('reference', '=', reference), ('provider_code', '=', 'razorpay')])
