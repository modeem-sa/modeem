modeem.define('web_editor.test_utils', function (require) {
"use strict";

var ajax = require('web.ajax');
var MockServer = require('web.MockServer');
var testUtils = require('web.test_utils');
var ModeemEditorLib = require('@web_editor/js/editor/modeem-editor/src/ModeemEditor');
...
var testKeyboard = function ($editable, assert, keyboardTests, addTests) {
    ...
    function nextPoint(point) {
        var node, offset;
        if (ModeemEditorLib.nodeSize(point.node) === point.offset) {
            node = point.node.parentNode;
            offset = ModeemEditorLib.childNodeIndex(point.node) + 1;
