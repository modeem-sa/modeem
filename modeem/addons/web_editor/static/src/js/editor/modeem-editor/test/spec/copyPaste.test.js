...
import {CLIPBOARD_WHITELISTS} from "../../src/ModeemEditor.js";
...
const pasteModeemEditorHtml = async (editor, html) => pasteData(editor, html, 'text/modeem-editor');
...
describe('Copy', () => {
    ...
    describe('range not collapsed', async () => {
        it('should copy a selection as text/plain, text/html and text/modeem-editor', async () => {
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/modeem-editor')).to.be.equal('bcd');
                },
            });
            await testEditor(BasicEditor, {
                ...
                stepFunction: async editor => {
                    ...
                    window.chai.expect(clipboardData.getData('text/modeem-editor')).to.be.equal('abc<br>efg');
                },
            });
        });
    });
...
describe('Cut', () => {
    ...
    describe('range not collapsed', async () => {
        it('should cut a selection as text/plain, text/html and text/modeem-editor', async () => {
            await testEditor(BasicEditor, {
                contentBefore: '<p>a[bcd]e</p>',
                stepFunction: async editor => {
                    const clipboardData = new DataTransfer();
...
describe('Paste', () => {
        ...
        describe('range collapsed', async () => {
            it('should paste and transform an image URL in a p', async () => {
                await testEditor(BasicEditor, {
                    contentBefore: '<p>ab[]cd</p>',
                    stepFunction: async editor => {
                        await pasteText(editor, 'https://download.modeemcdn.com/icons/website/static/description/icon.png');
                    ...
                    contentAfter: '<p>ab<img src="https://download.modeemcdn.com/icons/website/static/description/icon.png">[]cd</p>',
                });
            });
            it('should paste and transform an image URL in a span', async () => {
                await testEditor(BasicEditor, {
                    ...
                    contentAfter: '<p>a<span>b<img src="https://download.modeemcdn.com/icons/website/static/description/icon.png">[]c</span>d</p>',
                });
            });
            it('should paste and transform an image URL in an existing link', async () => {
                await testEditor(BasicEditor, {
                    ...
                    contentAfter: '<p>a<a href="http://existing.com">b<img src="https://download.modeemcdn.com/icons/website/static/description/icon.png">[]c</a>d</p>',
                });
            });
        });
        describe('range not collapsed', async () => {
    ...
    describe('Modeem editor own html', () => {
        it('should paste html as is', async () => {
            await testEditor(BasicEditor, {
                contentBefore: '<p>a[]b</p>',
                stepFunction: async editor => {
                    await pasteModeemEditorHtml(editor, '<div class="custom-paste">b</div>');
                },
        ...
        it('should not paste unsafe content', async () => {
            await testEditor(BasicEditor, {
                contentBefore: '<p>a[]b</p>',
                stepFunction: async editor => {
                    await pasteModeemEditorHtml(editor, `<script>console.log('xss attack')</script>`);
                },
