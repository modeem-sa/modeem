...
export class ModeemEditor extends EventTarget {
    constructor(editable, options = {}) {
        ...
        this.editable.classList.add("modeem-editor-editable");
    ...
    _onClipboardCopy(clipboardEvent) {
        ...
        const modeemHtml = dataHtmlElement.innerHTML;
        const modeemText = selection.toString();
        clipboardEvent.clipboardData.setData('text/plain', modeemText);
        clipboardEvent.clipboardData.setData('text/html', modeemHtml);
        clipboardEvent.clipboardData.setData('text/modeem-editor', modeemHtml);
    }
    /**
     * @private
     */
    ...
    isSelectionInBlockRoot() {
        ...
        while (
            ...
            !currentNode.classList.contains('modeem-editor-editable') &&
    ...
    _onPaste(ev) {
        ...
        const modeemEditorHtml = ev.clipboardData.getData('text/modeem-editor');
        ...
        if (modeemEditorHtml && targetSupportsHtmlContent) {
            const fragment = parseHTML(modeemEditorHtml);
