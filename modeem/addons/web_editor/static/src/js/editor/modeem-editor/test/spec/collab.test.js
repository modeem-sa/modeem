import { ModeemEditor } from '../../src/ModeemEditor.js';
import {
    insertCharsAt,
...
const testMultiEditor = spec => {
    ...
    for (const clientInfo of clientInfosList) {
        ...
        let nextId = 1;
        ModeemEditor.prototype._generateId = () => 'fake_id_' + nextId++;

        clientInfo.editor = new ModeemEditor(clientInfo.editable, {
            toSanitize: false,
    ...
    ModeemEditor.prototype._generateId = () => 'fake_concurent_id_' + concurentNextId++;
