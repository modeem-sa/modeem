modeem.define('web_editor.wysiwyg.iframe', function (require) {
'use strict';
...
Wysiwyg.include({
    ...
    _loadIframe: function () {
        ...
        this.$editable = $('<div class="note-editable oe_structure modeem-editor-editable"></div>');
        this.$el.removeClass('note-editable oe_structure modeem-editor-editable');
        if (isEditableRoot) {
        ...
        var def = new Promise(function (resolve) {
            window.top[self._onUpdateIframeId] = function (_avoidDoubleLoad) {
                ...
                const $iframeWrapper = $('<div class="iframe-editor-wrapper modeem-editor">');
