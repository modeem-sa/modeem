...
Also, adds methods to convert values back to Modeem models.
"""
...
import modeem.modules

from modeem import _, api, models, fields
from modeem.exceptions import UserError, ValidationError
from modeem.tools import ustr, posix_to_ldml, pycompat
from modeem.tools import html_escape as escape
from modeem.tools.misc import get_lang, babel_locale_parse
...
class Image(models.AbstractModel):
    ...
    def load_local_url(self, url):
        ...
        path = modeem.modules.get_module_resource(
