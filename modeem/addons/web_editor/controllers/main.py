...
from modeem import http, tools, _, SUPERUSER_ID
from modeem.addons.http_routing.models.ir_http import slug, unslug
from modeem.addons.web_editor.tools import get_video_url_data
from modeem.exceptions import UserError, MissingError, ValidationError
from modeem.modules.module import get_resource_path
from modeem.tools import file_open
from modeem.tools.mimetypes import guess_mimetype
from modeem.tools.image import image_data_uri, binary_to_image
...
DEFAULT_LIBRARY_ENDPOINT = 'https://media-api.modeem.com'
...
def handle_history_divergence(record, html_field_name, vals):
    ...
    # comes from the modeem editor or the collaboration was not activated. In
