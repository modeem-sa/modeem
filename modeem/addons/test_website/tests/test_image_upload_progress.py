...
from modeem.addons.web_editor.controllers.main import Web_Editor
from modeem.addons.web_unsplash.controllers.main import Web_Unsplash
...
class TestImageUploadProgress(modeem.tests.HttpCase):
