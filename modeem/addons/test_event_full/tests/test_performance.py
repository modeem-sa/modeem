...
from modeem.addons.test_event_full.tests.common import TestEventFullCommon
...
class TestOnlineEventPerformance(EventPerformanceCase, UtilPerf):
    ...
    #                 'modeem.__DEBUG__.services["web_tour.tour"].run("wevent_performance_register")',
    #                 'modeem.__DEBUG__.services["web_tour.tour"].tours.wevent_performance_register.ready',
    #                 login=None,
    #                 timeout=200,
    #             )
