...
from modeem.tests.common import TransactionCase, can_import
from modeem.modules.module import get_module_resource
from modeem.tools import mute_logger, pycompat
from modeem.addons.base_import.models.base_import import ImportValidationError
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('modeem.addons.base_import.models.base_import')
