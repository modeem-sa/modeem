...
from modeem import tests
from modeem.fields import Datetime
from modeem.modules.module import get_module_resource
...
class TestUi(TestUICommon):
    ...
    def test_course_member_employee(self):
        ...
        self.browser_js(
            '/slides',
            'modeem.__DEBUG__.services["web_tour.tour"].run("course_member")',
            'modeem.__DEBUG__.services["web_tour.tour"].tours.course_member.ready',
    ...
    def test_full_screen_edition_website_restricted_editor(self):
        ...
        self.browser_js(
            ...
            'modeem.__DEBUG__.services["web_tour.tour"].run("full_screen_web_editor")',
            'modeem.__DEBUG__.services["web_tour.tour"].tours.full_screen_web_editor.ready',
            login=user_demo.login)
...
class TestUiPublisher(HttpCaseWithUserDemo):
    ...
    def test_course_publisher_elearning_manager(self):
        ...
        self.browser_js(
            self.env['website'].get_client_action_url('/slides'),
            'modeem.__DEBUG__.services["web_tour.tour"].run("course_publisher_standard")',
            'modeem.__DEBUG__.services["web_tour.tour"].tours.course_publisher_standard.ready',
            login=user_demo.login)
...
class TestUiPublisherYoutube(HttpCaseWithUserDemo):
    ...
    def test_course_member_yt_employee(self):
        ...
        self.browser_js(
            '/slides',
            'modeem.__DEBUG__.services["web_tour.tour"].run("course_member_youtube")',
            'modeem.__DEBUG__.services["web_tour.tour"].tours.course_member_youtube.ready',
            login=user_demo.login)
    ...
    def test_course_publisher_elearning_manager(self):
        ...
        self.browser_js(
            self.env['website'].get_client_action_url('/slides'),
            'modeem.__DEBUG__.services["web_tour.tour"].run("course_publisher")',
            'modeem.__DEBUG__.services["web_tour.tour"].tours.course_publisher.ready',
            login=user_demo.login)
