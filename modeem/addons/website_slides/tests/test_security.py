...
from modeem.addons.website_slides.tests import common
...
class TestAccess(common.SlidesCase):
    ...
    @mute_logger('modeem.models', 'modeem.addons.base.models.ir_rule')
...
class TestAccessFeatures(common.SlidesCase):
    ...
    @mute_logger('modeem.models.unlink', 'modeem.addons.base.models.ir_rule', 'modeem.addons.base.models.ir_model')
