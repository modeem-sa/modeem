...
/**
  * This file should be used in the context of an external widget loading (e.g: live chat in a non-Modeem website)
  ...
  * As we're not in an Modeem website context, the calls will not work, and we avoid a 404 request.
  */
