...
from modeem import models, fields, api, _
from modeem.tools.pdf import ModeemPdfFileReader
from modeem.osv import expression
from modeem.tools import html_escape
from modeem.exceptions import RedirectWarning
...
class AccountEdiFormat(models.Model):
    ...
    def _create_invoice_from_pdf_reader(self, filename, reader):
        ...
        :param reader:   The ModeemPdfFileReader of the pdf to import.
        :returns:        The created invoice.
        """
        # TO OVERRIDE
        self.ensure_one()
    ...
    def _decode_pdf(self, filename, content):
        ...
        * pdf_reader:       The pdf_reader if type is pdf.
        ...
        try:
            ...
            pdf_reader = ModeemPdfFileReader(buffer, strict=False)
        except Exception as e:
            # Malformed pdf
