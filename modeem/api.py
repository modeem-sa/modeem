...
"""The Modeem API module defines Modeem Environments and method decorators.
...
def constrains(*args):
    ...
    Should raise :exc:`~modeem.exceptions.ValidationError` if the
    validation failed.
...
def ondelete(*, at_uninstall):
    """
    Mark a method to be executed during :meth:`~modeem.models.BaseModel.unlink`.
...
def onchange(*args):
    ...
    .. warning::
        ...
        itself via onchange. This is a webclient limitation - see `#2693 <https://github.com/modeem/modeem/issues/2693>`_.
...
class Environment(Mapping):
    ...
    def envs(cls):
        raise NotImplementedError(
            "Since Modeem 15.0, Environment.envs no longer works; "
    ...
    def manage(cls):
        warnings.warn(
            "Since Modeem 15.0, Environment.manage() is useless.",
    ...
    def __call__(self, cr=None, user=None, context=None, su=None):
        ...
        :type cursor: :class:`~modeem.sql_db.Cursor`
    ...
    def user(self):
        ...
        :rtype: :class:`res.users record<~modeem.addons.base.models.res_users.Users>`"""
    ...
    def company(self):
        ...
        :rtype: :class:`res.company record<~modeem.addons.base.models.res_company.Company>`
    ...
    def companies(self):
        ...
        :rtype: :class:`res.company recordset<~modeem.addons.base.models.res_company.Company>`
    ...
    def clear_upon_failure(self):
        ...
        """
        warnings.warn(
            "Since Modeem 15.0, use cr.savepoint() instead of env.clear_upon_failure().",
            DeprecationWarning, stacklevel=2,
        )
