...
import modeem
from modeem.loglevels import ustr
...
def plaintext2html(text, container_tag=None):
    ...
    html entities, using :func:`~modeem.tools.misc.html_escape`.
...
def email_normalize(text, strict=True):
    ...
    :param bool strict: text should contain exactly one email (default behavior
      and unique behavior before Modeem16);
...
def encapsulate_email(old_email, new_email):
    ...
    * New From: notifications@modeem.com
    * Output: "Admin" <notifications@modeem.com>
    """
