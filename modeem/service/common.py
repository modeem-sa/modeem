...
RPC_VERSION_1 = {
        'server_version': modeem.release.version,
        'server_version_info': modeem.release.version_info,
        'server_serie': modeem.release.serie,
        'protocol_version': 1,
}
...
def exp_about(extended=False):
    ...
    if extended:
        return info, modeem.release.version
    return info

def exp_set_loglevel(loglevel, logger=None):
    # TODO Previously, the level was set on the now deprecated
    # `modeem.netsvc.Logger` class.
    return True
